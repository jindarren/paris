...
var renderChart = function() {
  ...
  //
  //var attrText=''
  //vis.data([profile]).selectAll('.sector_leaf_text').each(function() {
  //      $(this).on('click', function (event) {
  //        attrText = $(event.target)
  //        $('#slider').show()
  ...
  //  var attrVal = $(event.target)
  //  //console.log(attrVal.val())
  //  //console.log(attrText.html().replace(/\(\d+%\)/g, attrVal.val()))
  //  attrText.html(attrText.html().replace(/\(\d+%\)/g, '('+attrVal.val()+'%)'))
  //  var attrName = attrText.html().replace(/\(\d+%\)/g, '').trim()
  //  setBig5(attrName,attrVal.val())
  //  loadAd(Math.floor(Math.random()*22))
  //  $('#ad-title').attr('title',"We show this ad according to your personality big 5 value.");
  //  //$('#slider').hide()
  //})
...
//function setBig5(attrName, value){
//    var theProfile = JSON.parse(localStorage.getItem('profile'))
//    switch(attrName){
//        case "Adventurousness":
//            theProfile.tree.children[0].children[0].children[0].percentage = value;
//            break;
//        case "Artistic interests":
//            theProfile.tree.children[0].children[0].children[1].percentage = value;
//            break;
//        case "Emotionality":
//            theProfile.tree.children[0].children[0].children[2].percentage = value;
//            break;
//        case "Imagination":
//            theProfile.tree.children[0].children[0].children[3].percentage = value;
//            break;
//        case "Intellect":
//            theProfile.tree.children[0].children[0].children[4].percentage = value;
//            break;
//        case "Authority-challenging":
//            theProfile.tree.children[0].children[0].children[5].percentage = value;
//            break;
//        ////////////////////////////////
//        case "Achievement striving":
//            theProfile.tree.children[0].children[1].children[0].percentage = value;
//            break;
//        case "Cautiousness":
//            theProfile.tree.children[0].children[1].children[1].percentage = value;
//            break;
//        case "Dutifulness":
//            theProfile.tree.children[0].children[1].children[2].percentage = value;
//            break;
//        case "Orderliness":
//            theProfile.tree.children[0].children[1].children[3].percentage = value;
//            break;
//        case "Self-discipline":
//            theProfile.tree.children[0].children[1].children[4].percentage = value;
//            break;
//        case "Self-efficacy":
//            theProfile.tree.children[0].children[1].children[5].percentage = value;
//            break;
//        ////////////////////////////////
//        case "Activity level":
//            theProfile.tree.children[0].children[2].children[0].percentage = value;
//            break;
//        case "Assertiveness":
//            theProfile.tree.children[0].children[2].children[1].percentage = value;
//            break;
//        case "Cheerfulness":
//            theProfile.tree.children[0].children[2].children[2].percentage = value;
//            break;
//        case "Excitement-seeking":
//            theProfile.tree.children[0].children[2].children[3].percentage = value;
//            break;
//        case "Outgoing":
//            theProfile.tree.children[0].children[2].children[4].percentage = value;
//            break;
//        case "Gregariousness":
//            theProfile.tree.children[0].children[2].children[5].percentage = value;
//            break;
//        ////////////////////////////////
//        case "Altruism":
//            theProfile.tree.children[0].children[3].children[0].percentage = value;
//            break;
//        case "Cooperation":
//            theProfile.tree.children[0].children[3].children[1].percentage = value;
//            break;
//        case "Modesty":
//            theProfile.tree.children[0].children[3].children[2].percentage = value;
//            break;
//        case "Uncompromising":
//            theProfile.tree.children[0].children[3].children[3].percentage = value;
//            break;
//        case "Sympathy":
//            theProfile.tree.children[0].children[3].children[4].percentage = value;
//            break;
//        case "Trust":
//            theProfile.tree.children[0].children[3].children[5].percentage = value;
//            break;
//        ////////////////////////////////
//        case "Fiery":
//            theProfile.tree.children[0].children[4].children[0].percentage = value;
//            break;
//        case "Prone to worry":
//            theProfile.tree.children[0].children[4].children[1].percentage = value;
//            break;
//        case "Melancholy":
//            theProfile.tree.children[0].children[4].children[2].percentage = value;
//            break;
//        case "Immoderation":
//            theProfile.tree.children[0].children[4].children[3].percentage = value;
//            break;
//        case "Self-consciousness":
//            theProfile.tree.children[0].children[4].children[4].percentage = value;
//            break;
//        case "Susceptible to stress":
//            theProfile.tree.children[0].children[4].children[5].percentage = value;
//            break;
//    }
//    //console.log(theProfile.tree.children[0].children[0].children[0].percentage)
//        //showVizualization(theProfile);
//}
